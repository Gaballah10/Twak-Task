...
class NetworkConnectionUseCaseImpl @Inject constructor(): NetworkConnectionUseCase {
    ...
    private var state: MutableLiveData<NetworkConnectionUseCase.NetworkStates> = MutableLiveData<NetworkConnectionUseCase.NetworkStates>().apply {
